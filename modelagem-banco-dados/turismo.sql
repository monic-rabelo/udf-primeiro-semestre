...
-- adicionando nova linha a tabela eventos
-- INSERT INTO turismo.evento (id_evento, nome, preco) VALUES
-- (16, 'Evento aleatório', 600.00);

-- atualizando linha inserida
-- UPDATE turismo.evento 
-- SET nome = 'Evento estranho', preco = 100
-- WHERE id_evento = 16;

--deletando linha inserida
-- DELETE FROM turismo.evento
-- WHERE id_evento = 16;

-- SELECT * FROM turismo.evento;